...
import SelectForm from 'react-bootstrap/Form';
  ...
  return (
    ...
    <section className="signIn d-flex justify-content-center align-items-center pt-3">
      ...
      <Form>
          ...
          <div className="form-group">
          <Input  id={'exampleInputEmail1'} labeltext={'Email Address'} type={'text'} classes={'form-control'}
          ...
          <Input  labeltext={'Password'} type={'password'} classes={'form-control'}
          ...
          <button type='submit' onClick={handleSubmit} className="btn loginBtn" >Signup</button>
